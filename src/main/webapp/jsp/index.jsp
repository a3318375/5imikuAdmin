...
<head>
    ...
    <!-- font-awesome.css -->
    <link href="${pageContext.request.contextPath}/resources/lay/plugin/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
    <!-- animate.css -->
    <link href="${pageContext.request.contextPath}/resources/lay/css/animate.min.css" rel="stylesheet" />
    <!-- 本页样式 -->
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            <div class="ht-console">
                <div class="ht-user">
                    <img src="${pageContext.request.contextPath}/resources/lay/images/Logo_40.png" />
                    <a class="ht-user-name">超级管理员</a>
                </div>
            </div>
            <span class="sys-title">绮梦楼后台管理系统</span>
            <ul class="ht-nav">
        ...
        <div class="layui-footer">
            <p style="line-height:44px;text-align:center;">绮梦楼后台管理系统 - Design By LY</p>
        </div>
        <!--快捷菜单-->
