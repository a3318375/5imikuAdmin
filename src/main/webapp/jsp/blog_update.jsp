                ...
                <form class="layui-form form-main" id="myfrom" action="${pageContext.request.contextPath}/blog/updateBlog">+
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="blogName" value="${blogVo.blogInfo.blogTitle}" required="" lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">摘要</label>
                        <div class="layui-input-block">
                            <input type="text" name="blogAbstract" value="${blogVo.blogInfo.blogAbstract}" lay-verify="required" placeholder="请输入摘要" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item layui-form-text">
                        ...
                        <div class="layui-input-block">
                            ...
                            <textarea id="demo" style="display: none;">${blogVo.context}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item" style="position:relative;">
                        <label class="layui-form-label">封面</label>
                        <div class="layui-input-inline">
                            <input name="blogCover" type="hidden" id="blogCover" value="${blogVo.blogInfo.blogCover}/">
                            <img id="articleCoverImg" class="img-cover" src="${blogVo.blogInfo.blogCover}" alt="封面">
                        </div>
